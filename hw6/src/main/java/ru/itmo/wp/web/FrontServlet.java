...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        try {
            before = pageClass.getSuperclass().getDeclaredMethod("before", HttpServletRequest.class, Map.class);
            after = pageClass.getSuperclass().getDeclaredMethod("after", HttpServletRequest.class, Map.class);
        } catch (NoSuchMethodException ignored) {
